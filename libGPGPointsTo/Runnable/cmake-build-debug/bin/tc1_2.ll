...
bb:
  ...
  %tmp = load i32, i32* @a, align 4, !dbg !31
  switch i32 %tmp, label %bb5 [
    i32 1, label %bb1
    i32 2, label %bb2
    i32 3, label %bb3
    i32 5, label %bb4
...
bb6:                                              ; preds = %bb5, %bb4, %bb3, %bb2, %bb1
  %tmp7 = load i32*, i32** @w, align 8, !dbg !43
  %tmp8 = load i32**, i32*** @p, align 8, !dbg !44
  store i32* %tmp7, i32** %tmp8, align 8, !dbg !45
  ret void, !dbg !46
}
...
!3 = !DIFile(filename: "tc1.c", directory: "/home/jinx/IITB/MTP/mehul_mtp/libGPGPointsTo/GPG_Impl/TestCases")
!4 = !{}
...
!52 = !DILocation(line: 27, column: 2, scope: !47)
!53 = !DILocation(line: 28, column: 2, scope: !47)
